 ...
 *
 * Arguments    : const creal_T w[1856]
 *                const double hr[1856]
 *                creal_T y[64]
 * Return Type  : void
 */
void cuav_pfb_m64(const creal_T w[1856], const double hr[1856], creal_T y[64])
{
  creal_T b_hr[1856];
  int i;
...
/*
 * File trailer for cuav_pfb_m64.c
 *
 * [EOF]
 */
