...
同日第三条日志第 7 节），当日已重新下载，**现无缺口**。当日曾从 `T10010_S0000.mat` 切出一份
2000 万点的格式预演切片，原文件重下后该切片已按用户指示删除；预演本身的结论（复 int16 交织
逐位无损、外挂元数据可落地四态语义）保留在 WORKLOG 同日第三条日志第 8 节。**本目录现在只有
这份清单，没有任何 IQ 数据。**
